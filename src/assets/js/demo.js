...
$(function () {
    ...
    $(document).on('click', '.fixed-plugin .img-holder', function () {
    ...
    $(document).on('click', '.switch-image input', function () {
        ...
        if (background_image) {
            $('.switch-image .bootstrap-switch').removeClass("bootstrap-switch-off")
            $('.switch-image .bootstrap-switch').addClass("bootstrap-switch-on")
        }
        else {
            $('.switch-image .bootstrap-switch').addClass("bootstrap-switch-off")
            $('.switch-image .bootstrap-switch').removeClass("bootstrap-switch-on")
        }
    });

    // $('.switch-mini input').on("switchChange.bootstrapSwitch", function() {
    $(document).on('click', '.switch-mini input', function () {

        debugger
        $body = $('body');
        $input = $(this);

        let is_sidebar_mini = false;

        if (lbd.misc.sidebar_mini_active == true) {
            is_sidebar_mini = false;

            $('.switch-mini .bootstrap-switch').addClass("bootstrap-switch-off")
            $('.switch-mini .bootstrap-switch').removeClass("bootstrap-switch-on")
            ...
            setTimeout(function () {
                is_sidebar_mini = true;

                $('.switch-mini .bootstrap-switch').removeClass("bootstrap-switch-off")
                $('.switch-mini .bootstrap-switch').addClass("bootstrap-switch-on")
    ...
    $(document).on('click', '.switch-nav input', function () {
        $nav = $('nav.navbar').first();
        $nav.toggleClass("navbar-fixed");

        if ($nav.hasClass('navbar-fixed')) {
            $('.switch-nav .bootstrap-switch').removeClass("bootstrap-switch-off")
            $('.switch-nav .bootstrap-switch').addClass("bootstrap-switch-on")
        }
        else
        {
            $('.switch-nav .bootstrap-switch').addClass("bootstrap-switch-off")
